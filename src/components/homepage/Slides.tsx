    ...
    return (
        <div className="relative w-full h-[300px] md:h-[500px] lg:h-[600px] group">
            ...
            <div className="absolute inset-0 flex flex-col justify-center items-start p-4 sm:p-8 bg-black bg-opacity-0 group-hover:bg-opacity-50 rounded-xl transition duration-300 ease-in-out">
                <h3 className="text-sky-400 text-[24px] lg:text-[28px] group-hover:text-opacity-100 transition duration-300 ease-in-out">{title}</h3>
                {/* <h2 className="text-white text-[26px] md:text-[30px] lg:text-[44px] font-bold leading-[1.2] group-hover:text-opacity-100 transition duration-300 ease-in-out">{mainTitle}</h2> */}
