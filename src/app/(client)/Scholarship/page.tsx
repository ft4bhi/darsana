        ...
        return (
          <div className="prose max-w-none">
            <p>
              ...
              his school days, made a significant contribution to shaping the
              campus ethos at the NSSCE. An excellent student, he was also a
              committed supporter of students&apos; rights, an ardent leftist, a
              practical leader, a tenacious fighter, a devoted friend, and most
            ...
            <p>
              ...
              is increased to Rs 12,000, with the number of beneficiaries
              ...
              beneficiaries, doing well in life, are now enthusiastically
              contributing to the Endowment in whatever way possible.
            </p>
            <p>
              The Biju Cheriyan Endowment has now grown beyond just a
              scholarship scheme, with programs to equip the students in terms
              of better communication skills, career guidance sessions as well
              as motivational talks. Darsana members have also been mentoring
              some of the beneficiaries, spending time with them, guiding them
              over academic and personal difficulties, and enabling them to
              achieve better prospects. The Endowment is also used to organize
              regular academic programs to help the under-performers to learn
              better and progress towards their B.Tech degree. The Biju Cheriyan
              Endowment and the Scholarship are now well-known in the college
              and beyond, with the number of applications growing every year. We
              have had to regretfully reject quite a few suitable applicants, as
              the numbers are now going beyond our capacity to accommodate them,
