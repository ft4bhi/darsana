      ...
      case 'OUR STORY':
        return (
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <Image
              src={DarsanaEngineers}
              alt="Darsana Engineers"
            ...
            <p className="text-lg">
              ...
              organization arose during a meeting of a few progressive-thinking
              students from the 1991 graduating class of NSS College of
              Engineering, Palakkad (NSSCE). The meeting was called to consider
              establishing an endowment for NSS College of Engineering Palakkad
              students in honor of their batchmate, the late Comrade Biju
              Cheriyan. This sparked the idea of bringing together all
              like-minded students from the 1960s to the millennium batches.
              Darsana was inaugurated on August 5, 2007, by the then honorable
              Education Minister of Kerala M. A. Baby in a function organized at
              the NSSCE campus. It was presided over by the college principal.
              The then member of parliament for Palakkad constituency, N. N.
        ...
        return (
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <p className="text-lg">
              ...
              students, etc. We are the organizers of the Biju Cherian
              Scholarship which financially supports more than 40 engineering
              students with an annual budget outlay of Rs 5 lakhs. We are the
              proud organizers of IGNITE, the biggest innovation contest held
              for college students in Kerala. We are also very active in
              designing and constructing alternate and sustainable houses.
              Darsana has so far built 10 houses for the needy.
            </p>
          </div>
        );
      case 'OBJECTIVES':
        return (
          <div>
            <p className="text-lg">
              ...
              relevant initiatives in education, waste management, and
        ...
        return (
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <p className="text-lg">
              ...
              produced commendable results. Through chapters, Darsana&apos;s
              dream of becoming an umbrella organization for over 3000 former
              NSSCE students from the early 1960s to the present is being
              realized.
            </p>
            <Image
              src={DarsanaEngineers}
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-8">
      ...
      <p className="text-center text-lg mb-8 max-w-3xl mx-auto">
        We are a global diaspora of more than a thousand highly experienced and
        socially committed engineers. We work towards making a difference in the
        life of the needy and downtrodden.
      </p>
      ...
      <div className="mb-8 px-4">{renderTabContent()}</div>
    </div>
  );
};
